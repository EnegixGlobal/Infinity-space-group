      ...
      <footer className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-20 
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><Link to="/portfolio/exterior/residential" className="hover:text-white transition">Exterior – Residential</Link></li>
              <li><Link to="/portfolio/exterior/commercial" className="hover:text-white transition">Exterior – Commercial</Link></li>
              <li><Link to="/portfolio/interior/residential" className="hover:text-white transition">Interior – Residential</Link></li>
              <li><Link to="/portfolio/interior/commercial" className="hover:text-white transition">Interior – Commercial</Link></li>
              <li><Link to="/portfolio/floorplan" className="hover:text-white transition">Floor Plan</Link></li>
              <li><Link to="/portfolio/isometric" className="hover:text-white transition">Isometric</Link></li>
              <li><Link to="/portfolio/landscape" className="hover:text-white transition">Landscape</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><a href="https://www.instagram.com/infinity_space_group" target="_blank" rel="noreferrer" className="hover:text-white transition">Instagram</a></li>
              <li><a href="https://www.linkedin.com" target="_blank" rel="noreferrer" className="hover:text-white transition">LinkedIn</a></li>
              <li><a href="https://twitter.com" target="_blank" rel="noreferrer" className="hover:text-white transition">Twitter</a></li>
              <li><a href="https://www.facebook.com/infinityspaceofgroup" target="_blank" rel="noreferrer" className="hover:text-white transition">Facebook</a></li>
            </ul>
          </div>
